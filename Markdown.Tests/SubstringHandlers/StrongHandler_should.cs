...
namespace Markdown.Tests.SubstringHandlers
{
    public class StrongHandler_should
    {
        [TestCase("__text__", ExpectedResult = "<strong>text</strong>",
            TestName = "Simple text inside double underscore")]
        [TestCase("__a _b__", ExpectedResult = "<strong>a _b</strong>", TestName = "Ignore one uderscore without close")
        ]
        [TestCase("__ab__cd__", ExpectedResult = "<strong>ab__cd</strong>",
            TestName = "Igonre double uderscore inside word")]
        [TestCase("__a\\__b__", ExpectedResult = "<strong>a__b</strong>", TestName = "Ignore escape symbols")]
        [TestCase("__b a__a b__", ExpectedResult = "<strong>b a__a b</strong>",
            TestName = "Ignore double undercore inside word")]
        [TestCase("__a __bc__", ExpectedResult = "<strong>a __bc</strong>",
            TestName = "Ignore double underscore after whitespace")]
        [TestCase("__a  \r\nb__", ExpectedResult = "<strong>a<br />b</strong>",
            TestName = "Line break inside double underscore")]
