...
namespace Markdown.Tests.SubstringHandlers
{
    internal class LinkHandler_should
    {
        ...
        [TestCase("[__hello__](url)", ExpectedResult = "<a src='url'><strong>hello</strong></a>",
            TestName = "Title with strong")]
        [TestCase("[[hello]](url)", ExpectedResult = "<a src='url'>[hello]</a>",
            TestName = "Title with square brace inside")]
        [TestCase("[hello](url(()()))", ExpectedResult = "<a src='url(()())'>hello</a>",
            TestName = "Url with circular brace inside")]
        ...
        [TestCase("[a  \r\nb](abc)", ExpectedResult = "<a src='abc'>a<br />b</a>",
            TestName = "Line break inside link name")]
