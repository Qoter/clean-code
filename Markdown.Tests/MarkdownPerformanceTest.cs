...
namespace Markdown.Tests
{
    ...
    public class MarkdownPerformanceTest
    {
        ...
        [Benchmark]
        public string On10K() => new Md(MdSettings.Default).RenderTextToHtml(text10k);

        [Benchmark]
        public string On100K() => new Md(MdSettings.Default).RenderTextToHtml(text100k);

        [Benchmark]
        public string On1M() => new Md(MdSettings.Default).RenderTextToHtml(text1m);
